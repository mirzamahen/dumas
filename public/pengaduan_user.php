            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th>Tanggapan Balik</th>
                </tr>
              </thead>
              <tbody>
                <?php
                $stmt = $conn->prepare("SELECT pengaduan.judul_pengaduan, pengaduan.tracking, status_pengaduan.status, 
                                        pengaduan.tanggapan_balik
                                        FROM pengaduan
                                        JOIN status_pengaduan ON pengaduan.status_aduan = status_pengaduan.id_status
                                        JOIN users ON pengaduan.id_user = users.id_users
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>" . htmlspecialchars($row['tracking']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['status']) . "</td>";
                  echo "<td>" . htmlspecialchars($row['tanggapan_balik']) . "</td>";
                  echo "</tr>";
                }
