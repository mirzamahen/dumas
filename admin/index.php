                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                          ...
                          $detailUrl = "detail.php?id={$row['id_pengaduan']}";
                          ...
                          echo "<tr>
                                  ...
                                  <td>
                                    ...
                                    <a href='edit.php?id={$row['id_pengaduan']}' class='btn btn-primary' title='Edit'>
                      ...
                      echo "<tr><td colspan='9'>Tidak ada data</td></tr>"; // Adjust colspan to include No column
                  }
                  ?>
                  </tbody>
                </table>
